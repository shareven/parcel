...
class SmsParser {
    ...
    fun parseSms(sms: String): ParseResult {
        ...
        if(foundCode.isEmpty()){
           ...
           foundCode = if (codeMatcher.find()) codeMatcher.group(2)?.toString()?:"" else ""
        }



        return ParseResult(foundAddress, foundCode, foundAddress.isNotEmpty() && foundCode.isNotEmpty())
    }
